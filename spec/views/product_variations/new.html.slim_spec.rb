...
describe "product_variations/new.html.slim" do
  before(:each) do
    assign(:product_variation, stub_model(ProductVariation,
  ...
  it "renders new product_variation form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => product_variations_path, :method => "post" do
